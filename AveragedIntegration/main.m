...
figure(1)
set(gca, 'fontsize', 14)
plot(tPlot_Fin/86400,xPlot_Fin(:,1),'LineWidth',2)
title('Averaged Semi-major axis')
xlabel('Time (days)')
ylabel('\Delta a (km)')

figure(2)
set(gca, 'fontsize', 14)
plot(tPlot_Fin/86400,xPlot_Fin(:,2),'LineWidth',2)
title('Averaged Eccentricity')
xlabel('Time (days)')
ylabel('\Delta e')

figure(3)
set(gca, 'fontsize', 14)
plot(tPlot_Fin/86400,xPlot_Fin(:,3),'LineWidth',2)
title('Averaged Ascending Node')
xlabel('Time (days)')
ylabel('\Delta \Omega (deg)')

figure(4)
set(gca, 'fontsize', 14)
plot(tPlot_Fin/86400,xPlot_Fin(:,4),'LineWidth',2)
title('Averaged Argument of Periapsis')
xlabel('Time (days)')
ylabel('\Delta \omega (deg)')
toc